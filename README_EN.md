...
| Codex custom provider, Responses or tool-call failures | [Codex API setup and validation](https://docs.aifast.club/tools/codex/?utm_source=github&utm_medium=repository&utm_campaign=integration-guide&utm_content=developer-hub-problem-codex-en) | config.toml, provider, Responses, tool events, compaction and thread resume checks |
...
| [Codex API setup and validation](https://docs.aifast.club/tools/codex/?utm_source=github&utm_medium=repository&utm_campaign=integration-guide&utm_content=matrix-codex-en) | Developer-tool topic | Custom provider setup and Responses, tool-call, compaction and thread-resume validation |
